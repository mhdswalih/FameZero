...
const CarouselWithText: React.FC = () => {
  const carouselImages: CarouselImage[] = [
    ...
    { src: "/img/Tasty_roast.png", alt: "Breakfast menu highlights" },
    { src: "/img/Briyani.png", alt: "Brunch special items" },
  ];
  ...
  return (
    ...
    <motion.div
      ...
      className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mt-40 p-8 max-w-7xl mx-auto"
    >
