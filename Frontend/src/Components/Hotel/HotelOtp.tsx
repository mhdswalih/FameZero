...
import { HotelverifyOtp, resendOtp } from '../../Api/hotelApiCalls/HotelsApis';
import { useLocation, useNavigate } from 'react-router-dom';
import toast from 'react-hot-toast';

const HotelOTPVerificationPage = () => {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (otp.every(digit => digit !== '')) {
      const response = await HotelverifyOtp(email, code, userData);
      console.log(response,'this is reponse from otp page');
...
export default HotelOTPVerificationPage;